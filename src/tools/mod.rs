...
use cargo::{
    ...
    CargoPackageTool, CargoRemoveTool, CargoSearchTool, CargoTestTool, CargoUpdateTool, TestTool1,
    TestTool2,
};
...
pub fn handle_request(
    ...
    match tool_params {
        ...
        AllTools::TestTool1(tool) => tool.call_tool(),
        AllTools::TestTool2(tool) => tool.call_tool(),
    }
}
